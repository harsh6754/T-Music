...
const DetailsBar = () => {
  return (
    <DetailsBarWrapper>
      ...
      <div>
        <ContactsWrapper href="tel:+919636504390">
          <Icon.Phone size={20} color="rgb(252, 113, 137)" />
          <ContactText>+91-9636504390</ContactText>
        </ContactsWrapper>

        <ContactsWrapper href="mailto:uniquecoder6754@gmail.com">
          <Icon.Mail size={20} color="rgb(252, 113, 137)" />
          <ContactText>uniquecoder@gmail.com</ContactText>
        </ContactsWrapper>
      </div>
